...
*Exercise 4*: Interpreting the summary output
...
# the slope of NAP decreases if the interaction with Exposure is removed from the model. But, also the std.error decreases

...
With the `renv` package, the environment can be saved and re-loaded. This means, all your packages and their versions are stored and can automatically be reloaded by the next user. Would you like to practice this? See [this tutorial](https://rstudio.github.io/renv/articles/renv.html).

More about [reproducible workflows in RStudio](https://www.geo.uzh.ch/microsite/reproducible_research/post/rr-r-publication/).

*Additional* : Running the code below, you can learn about the option to "answer" to an input from RStudio. Just try out the code below, following the instructions.

```{r}
# To just see what will be written in your lockfile, run the following:
# and write "n" to the console when it asks you if you would like to activate this project vefore snapshot() is called.
# (for your own project, you will ofcorse activate the project.)
# When asking if you would like to proceed : "N"
renv::snapshot()
```
